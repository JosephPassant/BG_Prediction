...
class JPFormer(nn.Module):
    def __init__(self, enc_in, dec_in, c_out, seq_len, label_len, out_len, 
        ...
        DecAttn = MicroscaleAttention(d_model, n_heads=n_heads, window_size=6, overlap=3, dropout=dropout)
        CrossAttn = FullAttention(mask_flag=False, factor=factor, attention_dropout=dropout, output_attention=False)  # Full Cross-Attention
