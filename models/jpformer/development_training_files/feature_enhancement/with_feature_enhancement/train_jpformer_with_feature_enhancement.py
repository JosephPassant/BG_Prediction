...
sys.path.append("./BG_Prediction")
from shared_utilities.utilities import *
from shared_utilities.evaluation_FE import *
from shared_utilities.rmse_training_validation_modules import *
from models.jpformer import JPFormer  

PROJECT_ROOT = "./BG_Prediction"
...
config_path = os.join(PROJECT_ROOT, 'models', 'shared_config_files', 'base_training_config_with_feature_enhancement.json')
